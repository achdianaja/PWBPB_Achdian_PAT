        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header"><i class="fa fa-table"></i> Data sampah</div>
                            <div class="card-body">
                                    ...
                                    <table id="default-datatable" class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $item ->jumlah }}</td>
                                                <td>
                                                    <a href="/restore/{{ $item->id }}">
                                                        <button class="btn btn-primary">
                                                            <i class="fa-solid fa-trash-arrow-up" title="Restore">
                                                    ...
                                                    <a href="/delete/{{ $item->id }}">
                                                        <button class="btn btn-danger" id="confirm-btn-alert">
